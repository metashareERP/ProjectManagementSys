...
@Service
public class projectServiceImpl extends ServiceImpl<com.metaShare.modules.generate.dao.projectDao,com.metaShare.modules.generate.entity.project> implements com.metaShare.modules.generate.service.projectService {
	
	@Autowired
	private SysDictDao sysDictDao;
	
	@Override
	public boolean insert(com.metaShare.modules.generate.entity.project entity) {
		return super.insert(entity);
	}
	
	@Override
	public boolean updateById(com.metaShare.modules.generate.entity.project entity) {
	...
	public Result selectList(int pageNum,int pageSize) {
		try {
		   List<com.metaShare.modules.generate.entity.project> listInfo = this.selectList(null);
		    int total = listInfo.size();
		    PageDTO pageDTO = new PageTool<com.metaShare.modules.generate.entity.project>().getPage(listInfo, pageSize, pageNum);
