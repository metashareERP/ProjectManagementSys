...
@Service
public class taskServiceImpl extends ServiceImpl<com.metaShare.modules.generate.dao.taskDao,com.metaShare.modules.generate.entity.task> implements com.metaShare.modules.generate.service.taskService {
	
	@Autowired
	private SysDictDao sysDictDao;
	
	@Override
	public boolean insert(com.metaShare.modules.generate.entity.task entity) {
		return super.insert(entity);
	}
	
	@Override
	public boolean updateById(com.metaShare.modules.generate.entity.task entity) {
	...
	public Result selectList(int pageNum,int pageSize) {
		try {
		   List<com.metaShare.modules.generate.entity.task> listInfo = this.selectList(null);
		    int total = listInfo.size();
		    PageDTO pageDTO = new PageTool<com.metaShare.modules.generate.entity.task>().getPage(listInfo, pageSize, pageNum);
